...
void mpu_setup()
{
  ...
  mpu.setXGyroOffset(-82.00000);
  mpu.setYGyroOffset(-102.00000);
  mpu.setZGyroOffset(105.00000);
  mpu.setZAccelOffset(1084.00000); // 1688 factory default for my test chip
...
#define WIFI_SSID "._.6"
#define WIFI_PASSWORD "qwertyyyy"
#define MPU_ID "5"
...
void setup(void) {
  ...
  databasePath = "/MPU_READING/" + uid + "/MPU" + MPU_ID ;
  mpu_setup();
}
